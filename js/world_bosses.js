...
const WB_BOSSES = {
  shai_hulud: {
    ...
    phases: [
      ...
      { phase: "Fase 2",  damage: "1.2KK",          skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillTentacles" }, { name: "wbShaiSkillAcidSpit" }] },
      { phase: "Fase 3",  damage: "2.3KK",          skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillSubmersion", note: "wbShaiNoteTotalSilence" }] },
      { phase: "Fase 4",  damage: "3.5KK",          skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillTentacles" }, { name: "wbShaiSkillAcidSpit" }, { name: "wbShaiSkillTornado" }, { name: "wbShaiSkillHealCutRoar" }] },
      { phase: "Fase 5",  damage: "4.6KK",          skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillTentacles" }, { name: "wbShaiSkillSubmersion", note: "wbShaiNoteTotalSilence" }] },
      { phase: "Fase 6",  damage: "5.8KK",          skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillTentacles" }, { name: "wbShaiSkillAcidSpit" }, { name: "wbShaiSkillSandwormWaves" }] },
      { phase: "Fase 7",  damage: "7KK",            skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillTentacles" }, { name: "wbShaiSkillSubmersion", note: "wbShaiNoteTotalSilence" }] },
      { phase: "Fase 8",  damage: "8.2KK",          skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillTentacles" }, { name: "wbShaiSkillTornado", count: 2 }, { name: "wbShaiSkillAcidSpit", count: 2 }, { name: "wbShaiSkillHealCutRoar" }] },
      { phase: "Fase 9",  damage: "9.3KK",          skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillTentacles" }, { name: "wbShaiSkillSubmersion", note: "wbShaiNoteTotalSilence" }] },
      { phase: "Fase 10", damage: "10.5KK",         skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillTentacles" }, { name: "wbShaiSkillTornado" }, { name: "wbShaiSkillAcidSpit" }, { name: "wbShaiSkillSandwormWaves" }, { name: "wbShaiSkillHealCutRoar" }] },
      { phase: "Fase 11", damage: "11.8KK",         skills: [{ name: "wbShaiSkillBasicAttack" }, { name: "wbShaiSkillSubmersion", note: "wbShaiNoteTotalSilence" }, { name: "wbShaiSkillTentacles" }] },
    ],
    characters: {
      tank: [
  ...
  hiking_bear: {
    ...
    phases: [
      ...
      { phase: "Fase 2", damage: "1.1KK",          skills: [{ name: "wbHikingSkillBasicAttack" }, { name: "wbHikingSkillFrontalPickaxe" }, { name: "wbHikingSkillBigSmash" }, { name: "wbHikingSkillAntiRangedIce" }] },
      { phase: "Fase 3", damage: "2.2KK",          skills: [{ name: "wbHikingSkillBasicAttack" }, { name: "wbHikingSkillBigSmash" }, { name: "wbHikingSkillAntiRangedBarrier" }] },
      { phase: "Fase 4", damage: "3.3KK",          skills: [{ name: "wbHikingSkillBasicAttack" }, { name: "wbHikingSkillFrontalPickaxe" }, { name: "wbHikingSkillAntiRangedIce" }, { name: "wbHikingSkillAvalanche", note: "~60s" }] },
      { phase: "Fase 5", damage: "4.4KK",          skills: [{ name: "wbHikingSkillBasicAttack" }, { name: "wbHikingSkillFrontalPickaxe" }, { name: "wbHikingSkillBigSmash", note: "wbNoteAmplified" }, { name: "wbHikingSkillAntiRangedBarrier" }, { name: "wbHikingSkillAvalanche", note: "~50s" }] },
      { phase: "Fase 6", damage: "5.5KK",          skills: [{ name: "wbHikingSkillBasicAttack" }, { name: "wbHikingSkillFrontalPickaxe" }, { name: "wbHikingSkillBigSmash", note: "wbNoteAmplified" }, { name: "wbHikingSkillAntiRangedBarrier" }, { name: "wbHikingSkillAntiRangedIce" }] },
      { phase: "Fase 7", damage: "6.6KK",          skills: [{ name: "wbHikingSkillBasicAttack" }, { name: "wbHikingSkillFrontalPickaxe" }, { name: "wbHikingSkillBigSmash", note: "wbNoteAmplified" }, { name: "wbHikingSkillAntiRangedBarrier" }, { name: "wbHikingSkillAntiRangedIce" }, { name: "wbHikingSkillAvalanche" }] },
    ],
    characters: {
      tank: [
    ...
    rewards: [
      {
        ...
        items: [
          ...
          { itemKey: "awakeningStones",     count: 8,         icon: "sprites/icons/divine_crystal.gif" },
  ...
  byakko: {
    ...
    phases: [
      ...
      { phase: "Fase 2", damage: "1.1KK",          skills: [{ name: "wbByakkoSkillBasicClaw" }, { name: "wbByakkoSkillFrontalRoar" }] },
      { phase: "Fase 3", damage: "2.2KK",          skills: [{ name: "wbByakkoSkillBasicClaw" }, { name: "wbByakkoSkillTwoTigerWaves" }] },
      { phase: "Fase 4", damage: "3.3KK",          skills: [{ name: "wbByakkoSkillBasicClaw" }, { name: "wbByakkoSkillRapidClaws" }, { name: "wbByakkoSkillFrontalRoar" }] },
      { phase: "Fase 5", damage: "4.4KK",          skills: [{ name: "wbByakkoSkillBasicClaw" }, { name: "wbByakkoSkillSideClaw" }, { name: "wbByakkoSkillFrontalRoar" }] },
      { phase: "Fase 6", damage: "5.3KK",          skills: [{ name: "wbByakkoSkillBasicClaw" }, { name: "wbByakkoSkillFrontalRoar" }, { name: "wbByakkoSkillTwoTigerWaves" }, { name: "wbByakkoSkillBranches" }] },
      { phase: "Fase 7", damage: "6.4KK",          skills: [{ name: "wbByakkoSkillRapidClaws" }, { name: "wbByakkoSkillBranches" }] },
      { phase: "Fase 8", damage: "7.5KK",          skills: [{ name: "wbByakkoSkillRapidClaws" }, { name: "wbByakkoSkillSideClaw" }, { name: "wbByakkoSkillThreeTigerWaves" }, { name: "wbByakkoSkillBranches" }] },
      { phase: "Fase 9", damage: "8.6KK",          skills: [{ name: "wbByakkoSkillBasicClaw" }, { name: "wbByakkoSkillRapidClaws" }, { name: "wbByakkoSkillSideClaw" }, { name: "wbByakkoSkillFrontalRoar" }, { name: "wbByakkoSkillThreeTigerWaves" }] },
    ],
    characters: {
      dps: [
    ...
    rewards: [
      ...
      { tier: "Tier 1", damage: "16.000.000", items: [{ itemKey: "kidNecklace", count: 1, icon: "sprites/icons/accessory/kid_necklace.gif" }, { itemKey: "kidCoat", count: 1, icon: "sprites/icons/body/kid_jacket.gif" }, { itemKey: "kidPants", count: 1, icon: "sprites/icons/legs/kid_pants.gif" }, { itemKey: "kidEmblem", count: 1, icon: "sprites/icons/emblem/kid_emblem.gif" }, { itemKey: "kidGlasses", count: 1, icon: "sprites/icons/head/kid_glasses.gif" }, { itemKey: "awakeningStones", count: 8, icon: "sprites/icons/divine_crystal.gif" }, { itemKey: "dynamicDiamondMedal", count: 2, icon: "sprites/items/special/dynamic_diamond_medal.gif" }, { itemKey: "key", count: 1, icon: "sprites/items/special/key.png" }, { itemKey: "berries", count: "30.000", icon: null }, { itemKey: "glStaminaPotion", count: 4, icon: "sprites/items/special/gl_stamina_potion.png" }, { itemKey: "valorMedals", count: 18, icon: "sprites/items/special/valiance_medal.png" }, { itemKey: "byakkoArtifacts", count: 10, icon: "sprites/world_bosses/byakko/artifact.png" }] },
      { tier: "Tier 2", damage: "14.000.000", items: [{ itemKey: "kidNecklace", count: 1, icon: "sprites/icons/accessory/kid_necklace.gif" }, { itemKey: "kidCoat", count: 1, icon: "sprites/icons/body/kid_jacket.gif" }, { itemKey: "kidPants", count: 1, icon: "sprites/icons/legs/kid_pants.gif" }, { itemKey: "kidEmblem", count: 1, icon: "sprites/icons/emblem/kid_emblem.gif" }, { itemKey: "kidGlasses", count: 1, icon: "sprites/icons/head/kid_glasses.gif" }, { itemKey: "awakeningStones", count: 4, icon: "sprites/icons/divine_crystal.gif" }, { itemKey: "dynamicDiamondMedal", count: 1, icon: "sprites/items/special/dynamic_diamond_medal.gif" }, { itemKey: "key", count: 1, icon: "sprites/items/special/key.png" }, { itemKey: "berries", count: "25.000", icon: null }, { itemKey: "glStaminaPotion", count: 4, icon: "sprites/items/special/gl_stamina_potion.png" }, { itemKey: "valorMedals", count: 15, icon: "sprites/items/special/valiance_medal.png" }, { itemKey: "byakkoArtifacts", count: 5, icon: "sprites/world_bosses/byakko/artifact.png" }] },
      { tier: "Tier 3", damage: "12.000.000", items: [{ itemKey: "kidNecklace", count: 1, icon: "sprites/icons/accessory/kid_necklace.gif" }, { itemKey: "kidCoat", count: 1, icon: "sprites/icons/body/kid_jacket.gif" }, { itemKey: "kidPants", count: 1, icon: "sprites/icons/legs/kid_pants.gif" }, { itemKey: "kidEmblem", count: 1, icon: "sprites/icons/emblem/kid_emblem.gif" }, { itemKey: "kidGlasses", count: 1, icon: "sprites/icons/head/kid_glasses.gif" }, { itemKey: "awakeningStones", count: 2, icon: "sprites/icons/divine_crystal.gif" }, { itemKey: "dynamicDiamondMedal", count: 1, icon: "sprites/items/special/dynamic_diamond_medal.gif" }, { itemKey: "key", count: 1, icon: "sprites/items/special/key.png" }, { itemKey: "berries", count: "20.000", icon: null }, { itemKey: "glStaminaPotion", count: 4, icon: "sprites/items/special/gl_stamina_potion.png" }, { itemKey: "valorMedals", count: 10, icon: "sprites/items/special/valiance_medal.png" }, { itemKey: "byakkoArtifacts", count: 1, icon: "sprites/world_bosses/byakko/artifact.png" }] },
      { tier: "Tier 4", damage: "8.000.000",  items: [{ itemKey: "kidNecklace", count: 1, icon: "sprites/icons/accessory/kid_necklace.gif" }, { itemKey: "kidCoat", count: 1, icon: "sprites/icons/body/kid_jacket.gif" }, { itemKey: "kidPants", count: 1, icon: "sprites/icons/legs/kid_pants.gif" }, { itemKey: "kidEmblem", count: 1, icon: "sprites/icons/emblem/kid_emblem.gif" }, { itemKey: "kidGlasses", count: 1, icon: "sprites/icons/head/kid_glasses.gif" }, { itemKey: "key", count: 1, icon: "sprites/items/special/key.png" }, { itemKey: "berries", count: "15.000", icon: null }, { itemKey: "glStaminaPotion", count: 4, icon: "sprites/items/special/gl_stamina_potion.png" }, { itemKey: "valorMedals", count: 5, icon: "sprites/items/special/valiance_medal.png" }] },
      { tier: "Tier 5", damage: "4.000.000",  items: [{ itemKey: "key", count: 1, icon: "sprites/items/special/key.png" }, { itemKey: "berries", count: "10.000", icon: null }, { itemKey: "glStaminaPotion", count: 4, icon: "sprites/items/special/gl_stamina_potion.png" }, { itemKey: "valorMedals", count: 3, icon: "sprites/items/special/valiance_medal.png" }] },
      { tier: "Tier 6", damage: "2.000.000",  items: [{ itemKey: "key", count: 1, icon: "sprites/items/special/key.png" }, { itemKey: "berries", count: "7.000",  icon: null }, { itemKey: "glStaminaPotion", count: 4, icon: "sprites/items/special/gl_stamina_potion.png" }] },
      { tier: "Tier 7", damage: "50.000",     items: [{ itemKey: "key", count: 1, icon: "sprites/items/special/key.png" }, { itemKey: "berries", count: "5.000",  icon: null }, { itemKey: "glStaminaPotion", count: 4, icon: "sprites/items/special/gl_stamina_potion.png" }] },
    ],
  },
  ...
  bananawani: {
    ...
    phases: [
      ...
      { phase: "Fase 2",  damage: "1.2KK",          skills: [{ name: "wbBananawaniSkillBite" }, { name: "wbBananawaniSkillAirBlow" }] },
      { phase: "Fase 3",  damage: "2.4KK",          skills: [{ name: "wbBananawaniSkillBite" }, { name: "wbBananawaniSkillCharge" }] },
      { phase: "Fase 4",  damage: "3.6KK",          skills: [{ name: "wbBananawaniSkillBite" }, { name: "wbBananawaniSkillCrocodile" }, { name: "wbBananawaniSkillRocks" }] },
      { phase: "Fase 5",  damage: "4.8KK",          skills: [{ name: "wbBananawaniSkillBite" }, { name: "wbBananawaniSkillPillars" }, { name: "wbBananawaniSkillHealReduction" }] },
      { phase: "Fase 6",  damage: "6.0KK",          skills: [{ name: "wbBananawaniSkillCharge" }, { name: "wbBananawaniSkillAirBlow" }, { name: "wbBananawaniSkillRocks" }] },
      { phase: "Fase 7",  damage: "7.2KK",          skills: [{ name: "wbBananawaniSkillBite" }, { name: "wbBananawaniSkillCharge" }, { name: "wbBananawaniSkillCrocodile" }, { name: "wbBananawaniSkillPillars" }] },
      { phase: "Fase 8",  damage: "8.4KK",          skills: [{ name: "wbBananawaniSkillCharge" }, { name: "wbBananawaniSkillFans" }, { name: "wbBananawaniSkillRocks" }, { name: "wbBananawaniSkillHealReduction" }] },
      { phase: "Fase 9",  damage: "9.6KK",          skills: [{ name: "wbBananawaniSkillBite" }, { name: "wbBananawaniSkillCharge" }, { name: "wbBananawaniSkillCrocodile" }, { name: "wbBananawaniSkillPillars" }, { name: "wbBananawaniSkillFans" }] },
      { phase: "Fase 10", damage: "10.8KK",         skills: [{ name: "wbBananawaniSkillBite" }, { name: "wbBananawaniSkillCharge" }, { name: "wbBananawaniSkillCrocodile" }, { name: "wbBananawaniSkillAirBlow" }, { name: "wbBananawaniSkillPillars" }, { name: "wbBananawaniSkillRocks" }, { name: "wbBananawaniSkillHealReduction" }, { name: "wbBananawaniSkillFans" }] },
    ],
    characters: {
      dps: [
    ...
    rewards: [
      {
        ...
        items: [
          ...
          { itemKey: "awakeningStones",     count: 10,        icon: "sprites/icons/divine_crystal.gif" },
  ...
  plesiosaur: {
    ...
    phases: [
      ...
      { phase: "Fase 2", damage: "450K",           skills: [{ name: "wbPlesiosaurSkillHealingCut" }, { name: "wbPlesiosaurSkillBasicAttack" }, { name: "wbPlesiosaurSkillBubbles2" }] },
      { phase: "Fase 3", damage: "900K",           skills: [{ name: "wbPlesiosaurSkillHealingCut" }, { name: "wbPlesiosaurSkillBasicAttack" }, { name: "wbPlesiosaurSkillBubbles2" }, { name: "wbPlesiosaurSkillWaves", count: 1 }] },
      { phase: "Fase 4", damage: "1.3KK",          skills: [{ name: "wbPlesiosaurSkillSubmersion" }, { name: "wbPlesiosaurSkillWaves", count: 4 }, { name: "wbPlesiosaurSkillBasicAttack" }] },
      { phase: "Fase 5", damage: "1.8KK",          skills: [{ name: "wbPlesiosaurSkillHealingCut" }, { name: "wbPlesiosaurSkillBasicAttack" }, { name: "wbPlesiosaurSkillBubbles4" }] },
      { phase: "Fase 6", damage: "2.2KK",          skills: [{ name: "wbPlesiosaurSkillWaves", count: 4 }, { name: "wbPlesiosaurSkillAquaticEruptions" }, { name: "wbPlesiosaurSkillHealingCut" }, { name: "wbPlesiosaurSkillBasicAttack" }] },
      { phase: "Fase 7", damage: "2.9KK",          skills: [{ name: "wbPlesiosaurSkillHealingCut" }, { name: "wbPlesiosaurSkillAquaticEruptions" }, { name: "wbPlesiosaurSkillBubbles4" }, { name: "wbPlesiosaurSkillBasicAttack" }] },
    ],
    characters: {
      tank: [
        { id: "crocodile",      label: "Crocodile" },
  ...
  aokiji: {
    ...
    phases: [
      ...
      { phase: "Fase 2", damage: "450K",           skills: [{ name: "wbAokijiSkillIceSaber" }, { name: "wbAokijiSkillIceBlockPartisan" }, { name: "wbAokijiSkillAntiRangedIce" }] },
      { phase: "Fase 3", damage: "1.5KK",          skills: [{ name: "wbAokijiSkillIceSaber" }, { name: "wbAokijiSkillIceBlockPartisan" }, { name: "wbAokijiSkillIceTime" }, { name: "wbAokijiSkillFreezingStatus" }] },
      { phase: "Fase 4", damage: "2.5KK",          skills: [{ name: "wbAokijiSkillIceSaber" }, { name: "wbAokijiSkillIceBlockPartisan" }, { name: "wbAokijiSkillAntiRangedIce" }, { name: "wbAokijiSkillIceBlockPartisanMechanic" }] },
      { phase: "Fase 5", damage: "3.5KK",          skills: [{ name: "wbAokijiSkillIceSaber" }, { name: "wbAokijiSkillIceBlockPartisan" }, { name: "wbAokijiSkillAntiRangedIce" }, { name: "wbAokijiSkillIceTime" }, { name: "wbAokijiSkillIceAge" }] },
      { phase: "Fase 6", damage: "4.5KK",          skills: [{ name: "wbAokijiSkillIceSaber" }, { name: "wbAokijiSkillIceBlockPartisan" }, { name: "wbAokijiSkillAntiRangedIce" }, { name: "wbAokijiSkillFreezingStatus" }, { name: "wbAokijiSkillIceBlockPillars" }, { name: "wbAokijiSkillIceBlockPheasantBeak" }] },
      { phase: "Fase 7", damage: "5.5KK",          skills: [{ name: "wbAokijiSkillIceSaber" }, { name: "wbAokijiSkillIceBlockPartisan" }, { name: "wbAokijiSkillAntiRangedIce" }, { name: "wbAokijiSkillIceBlockPillars" }, { name: "wbAokijiSkillIceBlockPheasantBeak", note: "wbAokijiNoteRightSide" }] },
      { phase: "Fase 8", damage: "7KK",            skills: [{ name: "wbAokijiSkillIceSaber" }, { name: "wbAokijiSkillIceBlockPartisan" }, { name: "wbAokijiSkillAntiRangedIce" }, { name: "wbAokijiSkillIceTime" }, { name: "wbAokijiSkillIceAge" }, { name: "wbAokijiSkillIceBlockPartisanMechanic" }, { name: "wbAokijiSkillIceBlockPheasantBeak", note: "wbAokijiNoteRightSide" }] },
      { phase: "Fase 9", damage: "8.5KK",          skills: [{ name: "wbAokijiSkillIceSaber" }, { name: "wbAokijiSkillIceBlockPartisan" }, { name: "wbAokijiSkillAntiRangedIce" }, { name: "wbAokijiSkillIceAge" }, { name: "wbAokijiSkillFreezingStatus" }, { name: "wbAokijiSkillIceBlockPillars" }, { name: "wbAokijiSkillIceBlockPheasantBeak", note: "wbAokijiNoteRightSide" }] },
    ],
    characters: {
      tank: [
...
function buildRewards(t1, t2, t3, t4, t5, t6, t7, artifactItemKey, bossIcon) {
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...baseItems,
        { itemKey: "awakeningStones",     count: 4,        icon: "sprites/icons/divine_crystal.gif" },
    ...
    },
    {
      ...
      items: [
        ...baseItems,
        { itemKey: "awakeningStones",     count: 2,        icon: "sprites/icons/divine_crystal.gif" },
        { itemKey: "dynamicDiamondMedal", count: 1,        icon: "sprites/items/special/dynamic_diamond_medal.gif" },
        { itemKey: "key",                 count: 1,        icon: "sprites/items/special/key.png" },
